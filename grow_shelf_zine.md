...
![Rendered model](grow_shelf_transparent.png)
Modular indoor garden built from wood, light, and logic.

## 1 — What This Is
![Rendered model](grow_shelf_render.png)
...
Size: 40x23x46 cm  |  Capacity: 16 pots  |  Power: 5 V DC
...
## 3 — Bill of Materials
**Frame**
- 4 m of 18x18 mm pine/beech
- 4 x 400 mm (X), 4 x 230 mm (Y), 4 x 450 mm (Z)
- 24 x M5 bolts + nuts + washers

**Trays & Pots**
- 2 x baking trays (39x23x7 cm)
- 16 x pots Ø 70 mm x H 80 mm
- Potting soil
...
## 6 — Add Pots & Soil
Each tray holds 8 pots (2x4) with ~ 35 mm gap from walls.
